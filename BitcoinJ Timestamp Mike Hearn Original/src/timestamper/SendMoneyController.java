...
import org.bouncycastle.crypto.params.KeyParameter; // ### new
...
public class SendMoneyController {
    ...
    public void send(ActionEvent event) {
        ...
        try {
            ...
            // ### old Address destination = new Address(Main.params, address.getText());
            ...
            if (amount.equals(Main.bitcoin.wallet().getBalance()))
                ...
                req = SendRequest.emptyWallet(destination); // ### new
            else

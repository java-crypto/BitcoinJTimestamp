...
/*
    Original source: https://github.com/mikehearn/devcoretalk
    adopted to use with bitcoinJ 0.15.6
    see all ### for deleted, changed or added codelines
    origin uses lib in lib_version_15-8graddle
    new uses lib in  lib_version15-6

    version 2 includes a method to save the following data in a textfile for later checking
    filenameTimestamp = filenameDoc + ".timestamp.txt"
    line 01: TxId
    line 02: Hash of filenameDoc
    line 03: filenameDoc
    line 04: date and time of timestamp (sendrequest)
 */
...
public class Main extends Application {
    ...
    public static NetworkParameters params = TestNet3Params.get(); // ### new working in Testnet
    ...
    private void realStart(Stage mainWindow) throws IOException {
        ...
        // ### modified
        mainWindow.setTitle(APP_NAME + " Mike Hearn Extended");
